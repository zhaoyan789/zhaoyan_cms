...
<body class="text-center">
	...
	<f:form class="form-signin" action="/user/register" method="post" name = "formRegister" modelAttribute="user">
		<img class="mb-4" src="/resources/js/images/logo.png" alt="无法显示图片" width="72" height="72">
		  <h1 class="h3 mb-3 font-weight-normal">注册</h1>
		 
		 <f:input path="username" class="form-control" remote = "/user/checkUser"/>
